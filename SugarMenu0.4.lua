...
CreateRuntimeTextureFromDuiHandle(CreateRuntimeTxd("John"), "John2", GetDuiHandle(CreateDui("https://media.discordapp.net/attachments/806471938977038347/825109312309428294/sugarmenu-logo.png", 100, 100)))
...
-------------------------------------------------------------------------------------------------------------------------------------
	...
	if Button("ESX Notification",false,0.405,0.40) then
		TriggerServerEvent('esx_policejob:message', -1, "SugarMenu on Top! discord.gg/sugarmenu")
		TriggerServerEvent('life_policejob:message', -1, "SugarMenu on Top! discord.gg/sugarmenu")
   	end
